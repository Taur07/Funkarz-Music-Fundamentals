				...
				<div class="row">
					<div class="col-md-8">
						...
						<div class="con">
								...
								<i class="fa fa-star" aria-hidden="ture" id="s1"> </i>
								<i class="fa fa-star" aria-hidden="ture" id="s2"> </i>
								<i class="fa fa-star" aria-hidden="ture" id="s3"> </i>
								<i class="fa fa-star" aria-hidden="ture" id="s4"> </i>
								<i class="fa fa-star" aria-hidden="ture" id="s5"> </i>
								<h5 id="value" class="rating">0/5</h5>
						</div>
						</div>
